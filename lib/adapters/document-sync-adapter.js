...
import {LanguageClientConnection, FileChangeType, TextDocumentSyncKind, TextDocumentSyncOptions,
...
export default class DocumentSyncAdapter {
  ...
  constructor(connection: LanguageClientConnection, documentSyncKind: TextDocumentSyncOptions | number, _editorSelector: atom$TextEditor => boolean) {
